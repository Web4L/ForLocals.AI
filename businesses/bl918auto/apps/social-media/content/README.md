...
- **[June 20 Open House Posts](open-house-june-20.md)** — ⭐ the priority right
  now: a 7-post campaign on a countdown timeline to pack the Re-Brand Open House
  (free BBQ + giveaways, Fri Jun 20, 11am–2pm).
- **[Weekly Posts](weekly-posts.md)** — a ready-to-post sample week of always-on
  content (educational, proof, culture) for normal weeks.

## How to use it
1. Pick a post. Shoot the suggested visual on a phone (real beats polished).
2. Paste the caption, post on Facebook / Instagram.
